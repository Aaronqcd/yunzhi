...
<body>
	...
	<div class="panel-body" style="padding-top: 0px; padding-bottom: 0px;">
		<!-- toolbar -->
		<div id="toolbar">
			<button onclick="update('编辑','personalController.do?goUpdate','clientList',600,400)" id="btn_edit" class="btn btn-success btn-sm">
				<span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> 编辑
			</button>
			<button onclick="detail('查看','personalController.do?goDetail','clientList',600,400)" class="btn btn-info btn-sm">
		...
		var TableInit = function() {
			...
			oTableInit.Init = function() {
				$('#clientList').bootstrapTable({
									url : 'personalController.do?datagrid', //请求后台的URL（*）
									method : 'get', //请求方式（*）
