...
<t:datagrid name="roleList" title="common.role.list" actionUrl="roleController.do?newRoleGrid" fitColumns="true"  idField="id" sortName="id" sortOrder="desc" queryMode="group" btnCls="bootstrap">
	...
	$("#function-panel").panel(
		{
			...
			href:"roleController.do?newFun&roleId=" + id
		}
	);
	...
	$("#function-panel").panel(
		{
			...
			href:"roleController.do?newUserList&roleId=" + id
		}
	);
	//$('#function-panel').panel("refresh" );
