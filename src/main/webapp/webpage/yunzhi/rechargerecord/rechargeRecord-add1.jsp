...
<t:base type="bootstrap,bootstrap-table,layer,validform,bootstrap-form"></t:base>
 ...
 <div class="container" style="width:100%;">
	...
	<form class="form-horizontal" role="form" id="formobj" action="rechargeRecordController.do?doAdd" method="POST">
		...
		<div class="form-group">
			...
			<div class="col-sm-7">
				<div class="input-group" style="width:100%">
					<input id="money" name="money" type="text" maxlength="10" class="form-control input-sm" placeholder="请输入金额"  datatype="d" ignore="ignore" />
				</div>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-7">
				<div class="input-group" style="width:100%">
					<input id="prepaid" name="prepaid" type="text" maxlength="50" class="form-control input-sm" placeholder="请输入充值方式"  ignore="ignore" />
				</div>
			</div>
		</div>
		<div class="form-group">
